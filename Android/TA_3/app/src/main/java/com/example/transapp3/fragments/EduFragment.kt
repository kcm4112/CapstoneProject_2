...
import com.example.transapp3.databinding.FragmentEduBinding

class EduFragment : Fragment() {

    private var mBinding : FragmentEduBinding? = null
...
//          - attachToRoot: true 로 설정해 줄 경우 root의 자식 View로 자동으로 추가, false 일 경우 root는 생성되는 View의 layoutParam을 생성하는데만 사용
        val binding = FragmentEduBinding.inflate(inflater, container, false)
        mBinding = binding
